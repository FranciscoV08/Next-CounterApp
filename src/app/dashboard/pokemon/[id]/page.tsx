...
// GENERAR 150 paginas estaticas (El nombre es de next)
// TENEMOS QUE REGRESAR. Solo en build time
export async function generateStaticParams() {
  ...
  // return[
  //   // Tiene que regresar todos los parametros 
  //   { id: '1' },
  //   { id: '2' },
  //   { id: '3' },
  //   { id: '4' },
...
export async function generateMetadata( {params}:Props): Promise<Metadata>{
  ...
  try {
    ...
    return{
      ...
      description: `El pokemon no se logro encontrar`,
    }
  }
